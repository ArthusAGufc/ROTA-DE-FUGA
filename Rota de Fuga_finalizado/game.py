...
def game():
    ...
    class Moeda(pygame.sprite.Sprite):
        def __init__(self):
            pygame.sprite.Sprite.__init__(self)
            self.image = pygame.image.load('Moedas/Fup_coin_2.png')
    ...
    while pause:
        ...
        Texto_loop = Fonte_Texto1.render('Escapou do Loop!', True, (255, 255, 255))
        Texto_Saida_loop = Fonte_Texto1.render(f'Saidas Loop: {loops}', True, (255, 255, 255))       
        ...
        colisao_terra = pygame.sprite.spritecollide(nave, Terra_Sprites, False, pygame.sprite.collide_rect)
        ...
        def menu_morte():
           ...
           tela.blit(Texto_HighScore, (450, 215))
           tela.blit(Texto_Score, (270, 215))
           tela.blit(Texto_Coin_2, (270, 255))
           tela.blit(Texto_MaxCoin_2, (450, 255))
        ...
        def menu_venceu():
            ...
            pygame.display.set_caption('Rota de Fuga')
            background = pygame.image.load('Menu/Mapa-2.jpg')
            mural = pygame.image.load('Menu/CARD_VENCEU.png')
            mural = pygame.transform.scale(mural, (500, 300))
            ...
            tela.blit(background, (0, 0))
            tela.blit(mural, (230, 50))
            tela.blit(Texto_Ganhou,(305, 85))
            tela.blit(Texto_loop,(350,150))
            tela.blit(Texto_HighScore, (450, 215))
            tela.blit(Texto_Score, (270, 215))
            tela.blit(Texto_Coin_2, (270, 255))
            tela.blit(Texto_MaxCoin_2, (450, 255))
        ...
        # Arquivo Loops
        file = open('loops.txt', 'r')
        loops = file.read()

        if score == 6480:
            loops = int(loops) + 1
            
        file = open('loops.txt', 'w')
        file.write(f'{loops}')
        file.close()
